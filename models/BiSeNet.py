...
def build_bisenet(inputs, num_classes, preset_model='BiSeNet', frontend="MobileNetV2", weight_decay=1e-5, is_training=True, pretrained_dir="models"):
    """
    ...
    net_4 = AttentionRefinementModule(end_points['layer_11'], n_filters=64)

    net_5 = AttentionRefinementModule(end_points['layer_17'], n_filters=160)
